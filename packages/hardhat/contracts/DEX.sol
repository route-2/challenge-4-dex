...
mapping (address => uint256) public liquidity;
    ...
    function init(uint256 tokens) public payable returns (uint256) {
        ...
        require(token.transferFrom(msg.sender, address(this), tokens), "Tokens not sent!");
    ...
    function ethToToken() public payable returns (uint256 tokenOutput) {
        ...
        emit EthToTokenSwap(msg.sender,"ETH to token swap",msg.value,tokenOutput);
        return tokenOutput;
    ...
    function tokenToEth(uint256 tokenInput) public returns (uint256 ethOutput) {
        ...
        require(token.transferFrom(msg.sender, address(this), tokenInput), "Tokens not sent!"); // send tokens to contract
